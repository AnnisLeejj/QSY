...
public class DrugInventoryAdapter extends BaseAdapter {
	...
	public  DrugInventoryAdapter(Context context,ArrayList<TB_Degulatory.data> list,FirmTypeBean.Data data){
		this.list=list;
	...
	public  DrugInventoryAdapter(Context context,ArrayList<TB_Degulatory.data> list){
		this.list=list;
		this.context=context;
		this.state=state;
		this.mInflater=LayoutInflater.from(context);
	...
	public View getView(final int pronts, View arg1, ViewGroup arg2) {
		...
		layout.button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				String url="{\"RequestMethod\":\"get_firm_data_stock_by_id\",\"RequestParams\":\"{\\\"InventoryID\\\":\\\""+list.get(pronts).getID()+"\\\",\\\"IsMedicine\\\":true}\"}";
