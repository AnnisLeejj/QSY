...
import com.heking.qsy.activity.regulatory.Food.Bevera.adapter.FoodBeveraAdditivesUsedParameterAdapter;
 ...
 * @author jhw
 */
public class FoodBeveraAdditivesUsedParameterActivity extends Activity implements OnRefreshListener {
    private String url;
    ...
    private ArrayList<TB_FoodBeveraAdditivesUsedParamet.Data> list;

    private FoodBeveraAdditivesUsedParameterAdapter adapter;
    private int page = 1;
    ...
    private void iniData() {
        ...
        HttpHelper.getInstance().service.get(url).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new SingleObserver<String>() {
            ...
            public void onSuccess(String json) {
                Log.d("message", json);
                TB_FoodBeveraAdditivesUsedParamet TB_FoodBeveraAdditivesUsedParamet = ParsonJson.jsonToBeanObj("{\"Data\":" + json + "}", TB_FoodBeveraAdditivesUsedParamet.class);
                if (TB_FoodBeveraAdditivesUsedParamet != null) {
                    list = TB_FoodBeveraAdditivesUsedParamet.getData();
                    adapter = new FoodBeveraAdditivesUsedParameterAdapter(FoodBeveraAdditivesUsedParameterActivity.this, list, data);
