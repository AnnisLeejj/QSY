...
public class FoodBeveraAdditivesAdapter extends BaseAdapter {
	...
	public  FoodBeveraAdditivesAdapter(Context context,ArrayList<TB_BeveraProcurement.Data> list,FirmTypeBean.Data  data){
		this.list=list;
