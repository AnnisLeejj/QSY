...
public class FoodBeveraCleaningAndDisinfectionAdapter extends BaseAdapter {
	...
	public  FoodBeveraCleaningAndDisinfectionAdapter(Context context,ArrayList<TB_FoodBeveraCleaningAndDisinfection.Data> list,FirmTypeBean.Data  data){
		this.list=list;
	...
	public View getView(final int pronts, View arg1, ViewGroup arg2) {
		...
		layout.cose();
		layout.Name.setText(list.get(pronts).getChargePeople());
		layout.Nmaetype.setText(new Tooluite().getDate(list.get(pronts).getCleanDate(),"T"));
