...
public class FoodBeveraRawMaterialInventoryReturnAdapter extends BaseAdapter {
	...
	public  FoodBeveraRawMaterialInventoryReturnAdapter(Context context,ArrayList<TB_BeveraRawMaterialInventory.Data> list,FirmTypeBean.Data  data){
		this.list=list;
