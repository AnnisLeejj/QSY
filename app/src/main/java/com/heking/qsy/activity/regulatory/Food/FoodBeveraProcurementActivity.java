...
import com.heking.qsy.activity.regulatory.Food.Bevera.adapter.FoodBeverPurchasedAdapter;
 ...
 * @author jhw
 */
public class FoodBeveraProcurementActivity extends Activity implements OnRefreshListener {
    private String url;
    ...
    private FoodBeverPurchasedAdapter adapter;
    private int page = 1;
        ...
        HttpHelper.getInstance().service.get(url).observeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new SingleObserver<String>() {
            ...
            public void onSuccess(String json) {
                ...
                if (TB_BeveraProcurement != null) {
                    ...
                    adapter = new FoodBeverPurchasedAdapter(FoodBeveraProcurementActivity.this, list, data);
