...
public class BaoShunBaoYiAdapter extends BaseAdapter {
	
	private ArrayList<TB_BaoShunBaoYin.data>  list;
	private Context context;
	private LayoutInflater mInflater;
	private int state;
	private FirmTypeBean.Data data;
	public  BaoShunBaoYiAdapter(Context context,ArrayList<TB_BaoShunBaoYin.data> list){
		this.list=list;
	...
	public View getView(final int pronts, View arg1, ViewGroup arg2) {
		...
		layout.Nmaetype.setText(med+"-"+list.get(pronts).getManufacturer());
