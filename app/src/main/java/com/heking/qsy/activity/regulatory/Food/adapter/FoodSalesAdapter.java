...
public class FoodSalesAdapter extends BaseAdapter {
	...
	public FoodSalesAdapter(Context context,
			ArrayList<TB_FoodSalses.Data> list, FirmTypeBean.Data data,
			RegulatoryUTil uTil) {
		this.list = list;
	...
	public View getView(final int pronts, View arg1, ViewGroup arg2) {
		...
		case 4:
			...
			layout.Nmaetype.setText(list.get(pronts).getCustomer());
			break;
		case 5:
			layout.Name.setText(list.get(pronts).getProductName());
		...
		case 2:
			...
			layout.Nmaetype.setText(list.get(pronts).getSalesStaff());
		default:
			break;
		}
