...
import com.heking.qsy.activity.regulatory.Food.Bevera.adapter.FoodBeveraRawMaterialInventoryAdapter;
 ...
 * @author jhw
 */
public class FoodBeveraRawMaterialInventoryActivity extends Activity implements OnRefreshListener {
    private String url;
    ...
    private FoodBeveraRawMaterialInventoryAdapter adapter;
    private int page = 1;
    ...
    private void iniData() {
        ...
        HttpHelper.getInstance().service.get(url).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new SingleObserver<String>() {
            ...
            public void onSuccess(String value) {
                Log.d("message", value);
                TB_BeveraRawMaterialInventory TB_BeveraRawMaterialInventory = ParsonJson.jsonToBeanObj("{\"Data\":" + value + "}", TB_BeveraRawMaterialInventory.class);
                if (TB_BeveraRawMaterialInventory != null) {
                    list = TB_BeveraRawMaterialInventory.getData();
                    adapter = new FoodBeveraRawMaterialInventoryAdapter(FoodBeveraRawMaterialInventoryActivity.this, list, data);
