...
public class FoodPurchasedReturnAdapter extends BaseAdapter {
	...
	public  FoodPurchasedReturnAdapter(Context context,ArrayList<TB_FoodPurchasedRetrun.Data> list,FirmTypeBean.Data  data,RegulatoryUTil uTil){
		this.list=list;
