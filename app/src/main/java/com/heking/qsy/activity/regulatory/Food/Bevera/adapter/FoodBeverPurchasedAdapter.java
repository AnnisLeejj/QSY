...
public class FoodBeverPurchasedAdapter extends BaseAdapter {
	...
	public  FoodBeverPurchasedAdapter(Context context,ArrayList<TB_BeveraProcurement.Data> list,FirmTypeBean.Data  data){
		this.list=list;
	...
	public View getView(final int pronts, View arg1, ViewGroup arg2) {
		...
		layout.cose();
		layout.Name.setText(list.get(pronts).getBillNo());
		layout.Nmaetype.setText(new Tooluite().getDate(list.get(pronts).getFillInDatetime(),"T"));//+"-"+list.get(pronts).getCheckMan());
