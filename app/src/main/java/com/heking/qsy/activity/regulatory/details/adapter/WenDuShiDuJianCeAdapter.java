...
public class WenDuShiDuJianCeAdapter extends BaseAdapter {
	
	private ArrayList<TB_WenDuShiDuJianCe.data>  list;
	private Context context;
	private LayoutInflater mInflater;
	private int state;
	private FirmTypeBean.Data data;
	public  WenDuShiDuJianCeAdapter(Context context,ArrayList<TB_WenDuShiDuJianCe.data> list){
		this.list=list;
	...
	public View getView(final int pronts, View arg1, ViewGroup arg2) {
		...
		layout.cose();
		layout.Name.setText(list.get(pronts).getStoreRoomName());
		...
		layout.Nmaetype.setText(med+"-"+list.get(pronts).getAddress());
