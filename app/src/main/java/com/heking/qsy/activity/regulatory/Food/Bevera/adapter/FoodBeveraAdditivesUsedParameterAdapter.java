...
public class FoodBeveraAdditivesUsedParameterAdapter extends BaseAdapter {
	...
	public  FoodBeveraAdditivesUsedParameterAdapter(Context context,ArrayList<TB_FoodBeveraAdditivesUsedParamet.Data> list,FirmTypeBean.Data  data){
		this.list=list;
	...
	public View getView(final int pronts, View arg1, ViewGroup arg2) {
		...
		layout.cose();
		layout.Name.setText(list.get(pronts).getBatchNumber());
		layout.Nmaetype.setText(new Tooluite().getDate(list.get(pronts).getDataUploadTime(),"T"));
