...
public class FoodBeveraRawMaterialInventoryAdapter extends BaseAdapter {
	...
	public  FoodBeveraRawMaterialInventoryAdapter(Context context,ArrayList<TB_BeveraRawMaterialInventory.Data> list,FirmTypeBean.Data  data){
		this.list=list;
