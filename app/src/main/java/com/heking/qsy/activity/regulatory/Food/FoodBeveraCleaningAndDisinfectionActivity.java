...
import com.heking.qsy.activity.regulatory.Food.Bevera.adapter.FoodBeveraCleaningAndDisinfectionAdapter;
 ...
 * @author jhw
 */
public class FoodBeveraCleaningAndDisinfectionActivity extends Activity implements   OnRefreshListener {
    private String url;
    ...
    private ArrayList<TB_FoodBeveraCleaningAndDisinfection.Data> list;

    private FoodBeveraCleaningAndDisinfectionAdapter adapter;
    private int page = 1;
    ...
    private void iniData() {
        ...
        HttpHelper.getInstance().service.get(url).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new SingleObserver<String>() {
            ...
            public void onSuccess(String json) {
                Log.d("message", json);
                TB_FoodBeveraCleaningAndDisinfection TB_FoodBeveraCleaningAndDisinfection = ParsonJson.jsonToBeanObj("{\"Data\":" + json + "}", TB_FoodBeveraCleaningAndDisinfection.class);
                if (TB_FoodBeveraCleaningAndDisinfection != null) {
                    list = TB_FoodBeveraCleaningAndDisinfection.getData();
                    adapter = new FoodBeveraCleaningAndDisinfectionAdapter(FoodBeveraCleaningAndDisinfectionActivity.this, list, data);
