...
import com.heking.qsy.activity.regulatory.Food.Bevera.adapter.FoodBeveraAdditivesAdapter;
 ...
 * @author jhw
 */
public class FoodBeveraAdditivesActivity extends BaseActivity implements OnRefreshListener {
    private String url;
    ...
    private FoodBeveraAdditivesAdapter adapter;
    private int page = 1;
        ...
        HttpHelper.getInstance().service.get(url).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new SingleObserver<String>() {
            ...
            public void onSuccess(String json) {
                ...
                if (TB_BeveraProcurement != null) {
                    ...
                    adapter = new FoodBeveraAdditivesAdapter(FoodBeveraAdditivesActivity.this, list, data);
