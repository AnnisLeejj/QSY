...
public class FoodCompanies extends Activity implements JSONdata,
        MessageAddress, OnClickListener {
    ...
    private RelativeLayout mArea, mFirm, mLevel;

    private TextView mtArea, mtFirm, mtLevel, mtArea_text, mtFirm_text,
            mtLevel_text;
    private boolean boArea = false;
    private boolean boFirm = false;
    private boolean boLevel = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.food_companies_layout_activity);
        iniView();
        iniData();
    }
    ...
    private void iniView() {
        ...
        mLevel = (RelativeLayout) findViewById(R.id.level_text_view_button);
        ...
        mtLevel_text = (TextView) findViewById(R.id.level_text_view_button_text);

        mtArea = (TextView) findViewById(R.id.area_text_view_button_img);
        mtFirm = (TextView) findViewById(R.id.firm_text_view_button_img);
        mtLevel = (TextView) findViewById(R.id.level_text_view_button_img);

        mListView = (ListView) findViewById(R.id.food_listView);
        mFiltrateMenu = new FiltrateMenu(LayoutInflater.from(this).inflate(
                R.layout.popwindows, null), this, this);
    ...
    private void iniData() {
        ...
        adapter = new FirmAdapter(FirmTapeDataList, FoodCompanies.this, 2222);
                    ...
                    mHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (AppContext.THEME) {
                                switch (onClickDate) {
                                    case 1:
                                        mtArea.setBackgroundDrawable(getResources()
                                                .getDrawable(
                                                        R.drawable.image_firm_3));
                                        mtLevel.setBackgroundDrawable(getResources()
                                                .getDrawable(
                                                        R.drawable.image_firm_1));
                                        mtFirm.setBackgroundDrawable(getResources()
                                                .getDrawable(
                                                        R.drawable.image_firm_1));
                                        break;
                                    case 2:
                                ...
                                mtArea.setBackgroundDrawable(getResources()
                                        .getDrawable(R.drawable.image_firm_2));
                                mtLevel.setBackgroundDrawable(getResources()
                                        .getDrawable(R.drawable.image_firm_2));
                                mtFirm.setBackgroundDrawable(getResources()
                                        .getDrawable(R.drawable.image_firm_2));
    ...
    // 将评分最高的展示在最前
    private ArrayList<FirmTypeBean.Data> Sort(
    ...
    public void httpResponse(String json) {
        ...
        FirmTypeBean bean = ParsonJson.jsonToBeanObj(JsonData,
                FirmTypeBean.class);
        ...
        switch (arg0.getId()) {
            case R.id.area_text_view_button:
                ...
                if (pop) {
                    ...
                    if (AppContext.THEME) {
                        if (boArea) {
                            mtArea.setBackgroundDrawable(getResources()
                                    .getDrawable(R.drawable.image_firm_3));
                            boArea = false;
                    ...
                    mtLevel_text.setTextColor(Color.parseColor("#808080"));
                    onClickDate = 1;
                    mtFirm.setBackgroundDrawable(getResources().getDrawable(
                            R.drawable.image_firm_1));
                    mtLevel.setBackgroundDrawable(getResources().getDrawable(
                            R.drawable.image_firm_1));
            ...
            case R.id.firm_text_view_button:
                ...
                if (pop) {
                    ...
                    mtLevel_text.setTextColor(Color.parseColor("#808080"));
                    mtArea.setBackgroundDrawable(getResources().getDrawable(
                            R.drawable.image_firm_1));
                    mtLevel.setBackgroundDrawable(getResources().getDrawable(
                            R.drawable.image_firm_1));
                    onClickDate = 2;
                ...
                break;
            case R.id.level_text_view_button:
                ...
                if (pop) {
                    ...
                    mtArea_text.setTextColor(Color.parseColor("#808080"));
                    mtFirm_text.setTextColor(Color.parseColor("#808080"));
                    mtLevel_text.setTextColor(Color.parseColor("#3cafdf"));
                    mtFirm.setBackgroundDrawable(getResources().getDrawable(
                            R.drawable.image_firm_1));
                    mtArea.setBackgroundDrawable(getResources().getDrawable(
                            R.drawable.image_firm_1));
                    onClickDate = 3;
                    showPopwindow(99903, mView, mLevel);
                    pop = true;
                }
                break;
    ...
    private void updateList() {
        ...
        while (iter.hasNext()) {
            ...
            boolean bFirmType = firmType.contains("全部企业") || data.getFirmTypeName().contains(firmType) || data.getFirmTypeName1().contains(firmType) ? true : false;
            boolean bRating = (rating == 0) || (data.getmRating() == rating) ? true : false;
            boolean bAddress = address.contains("全部区域") || data.getAreaName().contains(address) ? true : false;
            if (!bFirmType || !bRating || !bAddress) {
                iter.remove();
            }
            adapter.notifyDataSetChanged();
        }
