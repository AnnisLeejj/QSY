...
public class ZhouBianYaoDianActivity extends Activity {
...
//		mMapView.onCreate(savedInstanceState);
        Log.i("ZhouBianYaoDianActivity", "开始");
        iniView();
        iniData();
        iniButton();
    }
...
//					poiSearch= new PoiSearch(ZhouBianYaoDianActivity.this,query);
//					poiSearch.setBound(new SearchBound(mlatLonPoint, 3000));//设置周边搜索的中心点以及区域
//					poiSearch.setOnPoiSearchListener(ZhouBianYaoDianActivity.this);//设置数据返回的监听器
