...
public class FoodBeveraRelatedProductsAdapter extends BaseAdapter {
	...
	public  FoodBeveraRelatedProductsAdapter(Context context,ArrayList<TB_BeveraProcurement.Data> list,FirmTypeBean.Data  data){
		this.list=list;
	...
	public View getView(final int pronts, View arg1, ViewGroup arg2) {
		...
		layout.Nmaetype.setText(new Tooluite().getDate(list.get(pronts).getFillInDatetime(),"T"));
