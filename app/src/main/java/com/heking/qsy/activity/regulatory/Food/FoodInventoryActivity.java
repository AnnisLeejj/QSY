 ...
 * @author jhw
 */
public class FoodInventoryActivity extends Activity implements OnRefreshListener {
    private String url;
    ...
    private FoodInventoryAdapter adapter;
    private int page = 1;
        ...
        HttpHelper.getInstance().service.get(url).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new SingleObserver<String>() {
            ...
            public void onSuccess(String json) {
                ...
                if (TB_FoodInventory != null) {
                    ...
                    adapter = new FoodInventoryAdapter(FoodInventoryActivity.this, list, data, uTil);
