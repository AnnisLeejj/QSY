...
public class YaoXieMaintenanceAdapter extends BaseAdapter {
	
	private ArrayList<TB_YaoXieYangHu.data>  list;
	private Context context;
	private LayoutInflater mInflater;
	private int state;
	private FirmTypeBean.Data data;
	public  YaoXieMaintenanceAdapter(Context context,ArrayList<TB_YaoXieYangHu.data> list){
		this.list=list;
	...
	public View getView(final int pronts, View arg1, ViewGroup arg2) {
		...
		layout.Nmaetype.setText(med+"-"+list.get(pronts).getMaintainResult());
