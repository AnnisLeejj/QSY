...
public class FoodBeveraWasteDisposalAdapter extends BaseAdapter {
	...
	public  FoodBeveraWasteDisposalAdapter(Context context,ArrayList<TB_FoodBeveraWasteDisposal.Data> list,FirmTypeBean.Data  data){
		this.list=list;
	...
	public View getView(final int pronts, View arg1, ViewGroup arg2) {
		...
		layout.cose();
		layout.Name.setText(list.get(pronts).getSpecies());
		layout.Nmaetype.setText(new Tooluite().getDate(list.get(pronts).getProcessingDate(),"T"));
