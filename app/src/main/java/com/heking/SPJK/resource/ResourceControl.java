...
public final class ResourceControl {
    ...
    private void requestSubResFromRegion(int pId) {
        ...
        if (callback != null) {
            callback.onInfoResponse(responseFlag ? MsgIds.GET_SUB_F_R_SUC : MsgIds.GET_SUB_F_R_FAILED, allData);
        }
    }
    ...
    private void requestSubResFromCtrlUnit(int pId) {
        ...
        if (callback != null) {
            callback.onInfoResponse(responseFlag ? MsgIds.GET_SUB_F_C_SUC : MsgIds.GET_SUB_F_C_FAIL, allData);
        }
    }
    ...
    private void requestFirstList() {
        ...
        if (callback != null) {
            callback.onInfoResponse(ret ? MsgIds.GET_C_F_NONE_SUC : MsgIds.GET_C_F_NONE_FAIL, ctrlUnitList);
        }
    }
